    ...
    <div class="hero min-h-screen bg-base-200">
        <div class="hero-content flex w-full flex-col sm:flex-row">
            <div class="basis-2/3 text-left mr-8">
                <h1 class="text-5xl sm:text-7xl font-bold leading-12" v-html="$t('pages.coming-soon.title', { name: appName })"></h1>
                <h2 class="py-6" v-html="$t('pages.coming-soon.description', { name: appName })"></h2>
            </div>
            <div class="basis-1/3">
                    ...
                    <form class="card-body" @submit.prevent="submit">
                        <div class="form-control">
                            <label class="label mb-4">
                                <span class="label-text text-xl" v-html="$t('pages.coming-soon.waitlist.description', { name: appName })"></span>
                            </label>
